...
// ==========================================
// Served by the free Pollinations.ai backend (see ./freeapi.js).
...
export const freeT2iModels = [
  {
    ...
    "endpoint": "free",
    "inputs": {
      "prompt": { "description": "Text prompt describing the image you want.", "type": "string", "title": "Prompt", "name": "prompt" },
      "aspect_ratio": {
